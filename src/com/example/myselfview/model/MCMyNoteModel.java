package com.example.myselfview.model;
...
public class MCMyNoteModel implements Serializable {
	...
	public MCMyNoteModel modelWithData(Object data) {
        if(data != null && data.toString().length() > 0) {
            ...
            try {
				...
				model.setContent(obj.optString("note"));
				...
				System.out.println(obj.optString("====="+"updateDate"));		
